// Value Waterfall — horizontal waterfall showing revenue flow per scenario.
  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2">
        ...
        {isRecommended && (
          <span className="text-[10px] font-semibold uppercase tracking-wider px-2 py-0.5 rounded-full bg-success/10 text-success border border-success/30">
            Recommended
          </span>
        )}
      </div>
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-between">
        ...
        {isRecommended && (
          <span className="text-[9px] font-semibold uppercase px-1.5 py-0.5 rounded bg-success/10 text-success">
            ✓
          </span>
        )}
      </div>
      ...
      <div className="h-6 rounded overflow-hidden flex">
        ...
        <div
          className="h-full bg-muted-foreground flex items-center justify-center"
